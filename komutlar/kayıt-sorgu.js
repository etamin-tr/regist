...
exports.run = async (client, message, args) => {
    ...
    if(!message.member.roles.cache.some(r => ["763769937273028608", "763720890860568647"].includes(r.id)) && (!message.member.hasPermission("ADMINISTRATOR")))
...
.setFooter(`Hypnos <3`) // evet bilerek kaldırmadım ayriyetten sıfırdan yazdım :)
